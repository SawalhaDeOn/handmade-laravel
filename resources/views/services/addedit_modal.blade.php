...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        ...
        <!--begin::Scroll-->
        <form id="kt_modal_add_service_form" class="form" data-editMode="{{ isset($service) ? 'enabled' : 'disabled' }}"
              action="{{ isset($service) ? route('services.update', ['service' => $service->id]) : route('services.store') }}">
            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_service_scroll" data-kt-scroll="true"
                ...
                <div class="row">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <div class="image-input image-input-outline image-input-placeholder ms-5"
                            ...
                            <!--begin::Pservice existing avatar-->
                            <div class="image-input-wrapper w-125px h-125px"
                                 style="background-image: url('{{ isset($service) ? ($service->image_url != null ? asset('images/' . $service->image_url) : asset('media/avatars/blank.png')) : asset('media/avatars/blank.png') }}')">
                            </div>
                            <!--end::Pservice existing avatar-->
                            <!--begin::Label-->
                    ...
                    <div class="col-md-12">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="name" value="{{ isset($service) ? $service->name : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="name_en" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="name_en" value="{{ isset($service) ? $service->name_en : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="name_he" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="name_he" value="{{ isset($service) ? $service->name_he : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="fv-row mb-7">
                            ...
                            <textarea type="text" rows="2" name="notes"
                                      ...
                                      placeholder="name"> {{ isset($service) ? $service->notes : '' }} </textarea>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="fv-row mb-7">
                            ...
                            <textarea type="text" rows="2" name="notes_en"
                                      class="form-control form-control-solid mb-3 mb-lg-0"
                                      placeholder="name"> {{ isset($service) ? $service->notes_en : '' }} </textarea>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="fv-row mb-7">
                            ...
                            <textarea type="text" rows="2" name="notes_he"
                                      class="form-control form-control-solid mb-3 mb-lg-0"
                                      placeholder="name"> {{ isset($service) ? $service->notes_he : '' }} </textarea>
                            <!--end::Input-->
                        </div>
                    </div>
            ...
            <div class="text-center pt-15">
                <button type="reset" class="btn btn-light me-3" data-kt-services-modal-action="cancel"
