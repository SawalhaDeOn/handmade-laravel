                      ...
                      <div class="col-md-6">
                          <div class="fv-row mb-4">
                              ...
                              <input type="text" name="country_name_en"
                                     class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Country name"
                                     value="{{ isset($country) ? $country->name_en : '' }}" />
                              <!--end::Input-->
                          </div>
                      </div>
                      <div class="col-md-6">
                          <div class="fv-row mb-4">
                              <!--begin::Label-->
                              <label class="required fw-semibold fs-6 mb-2">Name He</label>
                              <!--end::Label-->
                              <!--begin::Input-->
                              <input type="text" name="country_name_he"
                                     class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Country name"
                                     value="{{ isset($country) ? $country->name_he : '' }}" />
                              <!--end::Input-->
                          </div>
                      </div>
