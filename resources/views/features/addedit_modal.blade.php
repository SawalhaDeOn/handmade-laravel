...
<div class="modal-content">
    ...
    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
        ...
        <!--begin::Scroll-->
        <form id="kt_modal_add_feature_form" class="form" data-editMode="{{ isset($feature) ? 'enabled' : 'disabled' }}"
              action="{{ isset($feature) ? route('features.update', ['feature' => $feature->id]) : route('features.store') }}">
            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_feature_scroll" data-kt-scroll="true"
                 data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                 data-kt-scroll-dependencies="#kt_modal_add_feature_header"
                 data-kt-scroll-wrappers="#kt_modal_add_feature_scroll" data-kt-scroll-offset="300px">
                <!--begin::Input group-->
                ...
                <div class="row">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <div class="image-input image-input-outline image-input-placeholder ms-5"
                            ...
                            <!--begin::Pfeature existing avatar-->
                            <div class="image-input-wrapper w-125px h-125px"
                                 style="background-image: url('{{ isset($feature) ? ($feature->image_url != null ? asset('images/' . $feature->image_url) : asset('media/avatars/blank.png')) : asset('media/avatars/blank.png') }}')">
                            </div>
                            <!--end::Pfeature existing avatar-->
                            <!--begin::Label-->
                    ...
                    <div class="col-md-12">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="name" value="{{ isset($feature) ? $feature->name : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="name_en" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="name_en" value="{{ isset($feature) ? $feature->name_en : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" name="name_he" class="form-control form-control-solid mb-3 mb-lg-0"
                                   placeholder="name_he" value="{{ isset($feature) ? $feature->name_he : '' }}"/>
                            <!--end::Input-->
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="fv-row mb-7">
                            ...
                            <textarea type="text" rows="2" name="notes"
                                      ...
                                      placeholder="name"> {{ isset($feature) ? $feature->notes : '' }} </textarea>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="fv-row mb-7">
                            ...
                            <textarea type="text" rows="2" name="notes_en"
                                      class="form-control form-control-solid mb-3 mb-lg-0"
                                      placeholder="name"> {{ isset($feature) ? $feature->notes_en : '' }} </textarea>
                            <!--end::Input-->
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="fv-row mb-7">
                            ...
                            <textarea type="text" rows="2" name="notes_he"
                                      class="form-control form-control-solid mb-3 mb-lg-0"
                                      placeholder="name"> {{ isset($feature) ? $feature->notes_he : '' }} </textarea>
                            <!--end::Input-->
                        </div>
                    </div>
            ...
            <div class="text-center pt-15">
                <button type="reset" class="btn btn-light me-3" data-kt-features-modal-action="cancel"
                        data-bs-dismiss="modal">Discard
                </button>
                <button type="submit" class="btn btn-primary" data-kt-features-modal-action="submit">
