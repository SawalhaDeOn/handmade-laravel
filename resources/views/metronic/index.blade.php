    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(".searchWhatClick").on('click', function () {
                ...
                jQuery('.unread_messages').html('<div class="spinner spinner-primary spinner-lg spinner-center"></div><br><br>');
                $('.unread_messages').load('/getUnreadMessages?sender=' + $('#ssender').val() + '&inputsearch=' + $('.searchinputWhat').val());
            ...
            $(".searchWhatClose").on('click', function () {
                $('.searchinputWhat').val('');
                jQuery('.unread_messages').html('<div class="spinner spinner-primary spinner-lg spinner-center"></div><br><br>');
                $('.unread_messages').load('/getUnreadMessages?sender=' + $('#ssender').val());
            });
