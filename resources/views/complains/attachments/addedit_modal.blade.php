  ...
  <div class="modal-content">
      ...
      <div class="modal-body scroll-y mx-5 my-7">
          ...
          <form id="kt_modal_add_attachment_form" class="form"
              ...
              action="{{ isset($attachment) ? route('complains.attachments.update', ['complain' => $complain->id, 'attachment' => $attachment->id]) : route('complains.attachments.store', ['complain' => $complain->id]) }}">
