...
@section('title', 'Lead-' . 'Add new lead')
@section('subpageTitle', 'Lead')
@section('subpageName', 'Add new lead')
...
@section('content')
    ...
    <div class="card mb-5 mb-xl-5" id="kt_lead_form_tabs">
        <div class="card-body pt-0 pb-0">
            ...
            <div class="d-flex my-4 justify-content-end order-lg-2 order-1">
                ...
                <a href="{{ route('leads.index') }}" class="btn btn-sm btn-light me-2"
    ...
    <form class="tab-content" id="myTabContent" method="post"
        ...
        <div class="tab-pane fade show active" id="kt_tab_pane_1" role="tabpanel">
            <div class="card mb-5 mb-xl-10" id="kt_clients_details_view">
                <!--begin::Card header-->
...
@push('scripts')
    ...
    <script>
        $(document).on('change', '#client_id', function (e) {
            var module = 'Client';
            var clients = this.value;


            jQuery.ajax({
                url: '/getSelect?module=' + module + "&category_id=" + clients,
                type: 'GET',
                dataType: "json",
