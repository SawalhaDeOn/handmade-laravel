                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-lead-table-toolbar="base">
                            ...
                            <a target="_blank" id="exportBtn" href="#"
                               data-export-url="{{ route('leads.export') }}" class="btn btn-primary me-3">
                ...
                <div class="card-body py-4">
                    ...
                    <table class="table table-bordered align-middle table-row-dashed fs-6 gy-5"
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-250px bold all">{{__('Client Name')}}</th>
                            <th class="min-w-100px bold all">{{__('Client Type')}}</th>
                            <th class="min-w-100px bold all">{{__('Client Telephone')}}</th>
                            <th class="min-w-100px bold all">{{__('Status')}}</th>
                            <th class="min-w-100px bold all">{{__('Action')}}</th>
                            <th class="min-w-100px bold all">{{__('Edit')}}</th>
            ...
            [
                ...
                },
                {
                    data: function (row, type, set) {
                        if (type === 'display') {
                            if (row.client)
                                if (row.client.categorys)
                                    return row.client.categorys.name;
                        }
                        return '';
                    },
