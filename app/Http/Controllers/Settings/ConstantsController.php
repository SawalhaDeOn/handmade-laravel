...
class ConstantsController extends Controller
{
    public function index(Request $request)
    {
        if ($request->isMethod('GET')) {
            ...
            $constants = Constant::query()
                ...
                ->groupBy('constants.module')->groupBy( 'constants.field')
                ->orderBy('module', 'asc');
            // dd(  $constants->get());
    ...
    public function edit(Request $request, $constant,$module)
    {
        // $id = $role = null;
        $request->validate([
            'constant' => 'string'
        ...
        $constants = Constant::where('field', $constant)->where('module',$module)->get();
