...
class CountryCityController extends Controller
{
    ...
    public function cities(Request $request)
    {
        ...
        return   DataTables::eloquent($cities)
            ...
            ->editColumn('name', function ($city) {
                return '<a href="' . route('settings.country-city.city.edit', ['city' => $city->id]) . '" targer="_blank" class="btnUpdateCity">
                         ' . $city->name . '
                    </a>';
            })
    ...
    public function country_store(Request $request)
    {
        ...
        $country->name_en = $request->country_name_en;
        $country->name_he = $request->country_name_he;
    ...
    public function city_store(Request $request)
    {
        ...
        $city->name_en = $request->city_name_en;
        $city->name_he = $request->city_name_he;
