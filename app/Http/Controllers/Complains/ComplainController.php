    ...
    public function index(Request $request)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            return DataTables::eloquent($complains)
                ...
                ->editColumn('patient.mobile', function ($complain) {
                    return '<a href="' . route('patients.patient_calls_sms_logs', ['patient' => $complain->patient_id]) . '" class="ShowPatientCallsSmsLogs">' . $complain->patient->mobile . '</a>';
                })
                ...
                ->rawColumns(['source', 'action','patient.mobile'])
